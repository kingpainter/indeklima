...
class IndeklimaPanel extends HTMLElement {
  ...
  _renderOverview(d) {
    ...
    const outdoorLine = vent.outdoor_temp != null
      ? `🌤️ ${this._fmt(vent.outdoor_temp, "°C", 1)} · 💧 ${this._fmt(vent.outdoor_humidity, "%", 0)} udenfor`
    ...
    return `
        ...
        <div class="section-box-body">
          ...
          <div class="ov-vent-detail">
            ...
            <div style="display:flex;flex-wrap:wrap;gap:6px;">
              ${reasonChips.map(r2 => `<div class="vent-reason-chip">⚠️ ${r2}</div>`).join("")}
            </div>
      ...
      <!-- Åbne vinduer/døre (kun vis hvis der er nogen) -->
      ...
      <div class="panel-topbar">
        <div class="header">
          ...
          <div class="header-text">
            <h1>Indeklima</h1>
            <div class="version">v${d?.version || "2.5.11"} · Gold Tier${this._lastLoad ? " · " + this._lastLoad.toLocaleTimeString("da-DK",{hour:"2-digit",minute:"2-digit"}) : ""}</div>
          </div>
